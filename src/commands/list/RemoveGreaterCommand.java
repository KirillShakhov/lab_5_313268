...
public class RemoveGreaterCommand implements Command {
    ...
    public RemoveGreaterCommand(CommandManager commandManager, CollectionShell collectionShell){
    ...
    public void execute(String option, ResultShell resultShell) throws CommandExecutingException {
        if (option.isEmpty()){
            resultShell.setCommandResult("Команда remove_greater должна иметь аргумент");
            return;
        }
